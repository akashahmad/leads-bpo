...
<h2 className="termsandcondition-heading">Using the Site</h2>
<div className="strong">
    <ol>
        ...
        <li>
        You are under no obligation to use our, nor our selected partners services by using this Site.
        </li>
        <li>
...
<div>
<h2 className="termsandcondition-heading">Ownership, use and intellectual property rights</h2>
</div>
<div>
    <ol className="strong">
        <li>
...
<div>
<h2 className="termsandcondition-heading">Submitting information to the Site</h2>
</div>
<div>
    <ol className="strong">
        <li>
...
<div>
<h2 className="termsandcondition-heading">Accuracy of information and availability of the Site
</h2>
</div>
<div>
    <ol className="strong">
...
<div>  <p className="ap">
No one other than a party to these Terms has any right to enforce any of these Terms.</p>
</div>
<div>
    <h2 className="termsandcondition-heading">
...
<p className="ap">
    ...
    <p className="ap">We vet our associated companies to ensure they:

Provide you with clear information about the products and services they offer, including fees and<br/>
 charges.</p>
 <p className="ap">
 Establish your individual needs, preferences and circumstances before allowing any application or <br/>
 enquiry for a particular debt solution is made via their services.
 </p>
 <p className="ap">Advise you on sources of information that would help you understand your situation and potential<br/>
  impacts of their services.</p>
  <p className="ap">Encourage you to ask if there’s something you don’t understand.</p>
  <p className="ap">Give you access to a formal complaints procedure should you become unhappy with their service.<br/>
   How you can help us</p>
<p className="ap">To help us give you the most appropriate advice, we will ask you to:
...
<div>
<h2 className="termsandcondition-heading">Our Cookies</h2>
...
<div>
 <h2 className="termsandcondition-heading">First party cookies</h2>
  </div>
  <div>
  <p className="ap">These are cookies we set and that our website needs in order to function and if they are not accepted <br/>
       by you, parts of the site won’t be usable. Example would be for us to save a visitor filter selection from <br/>
      our homepage. These cookies may be used to enable us to identify a visitor’s current browsing session <br/>
       and allows our website to function as intended. These cookies can also let us know what web channel <br/>
       you used to find us, along with the keyword you used.</p>
  </div>
