...
export default ()=>{
    return(
        ...
        <section className="">
            ...
            <div className="footer-div pt-5"><p className="footer-p1">Copyright 2019 debtexpertuk.netlify.com All Rights Reserved.</p></div>
            <div className="footer-div2 pt-4"><p>debtexpertuk.netlify.com is a trading style of Money Tree Media Limited.
            </p>
